...
class RentalSepeda:
    ...
    def sepedaPerJam(self, n):
        if n <= 0:
            ...
            print("Anda telah menyewa {} sepeda per jam hari ini pada jam {}.".format(
                n, now.hour))
            print("Anda akan dikenakan biaya $5 untuk 1 jam per sepeda.")

            self.unit -= n
            return now

    def sepedaTersedia(self, n):
        if n <= 0:
            print("ketersediaan Sepeda harus Positif")
            return None
    ...
    def sepedaPerMinggu(self, n):
        if n <= 0:
            ...
            print(
                "Maaf kami memiliki {} ketersediaan sepeda yang siap untuk disewa".format(self.unit))
            return None
...
class Customer:
    ...
    def requestBike(self):
        ...
        if bikes < 1:
            print("Jumlah sepeda harus lebih dari nol!")
            return -1
        else:
            self.bikes = bikes
        return self.bikes
...
def main():
    ...
    while True:
        print("""
        ====== Toko Sewa Sepeda =======
        1. Tampilkan ketersediaan sepeda yang siap untuk disewa
        2. Sewa sepeda 1 jam $5
        ...
        try:
            ...
            print("PILIHLAH SESUAI KEINGINAN ANDA")
            continue

        if pilih == 1:
            toko.ketersediaanSepeda()
            ...
            customer.waktuSewa = toko.sepedaTersedia(
                customer.requestBike())
            customer.sewa = 2
